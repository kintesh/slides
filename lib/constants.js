...
;(function(){
    ...
    exports.temp_slide = function(content) {
        return "<div class=\"slide\">\n"+content+"\n</div>\n";
    };
    exports.temp_title = function(title) {
        return "<div class=\"title_title\">"+title+"</div>";
    };
    exports.temp_subTitle = function(subTitle) {
        return "<div class=\"title_subTitle\">"+subTitle+"</div>";
    };
    ...
    exports.temp_inlineMath = "<div class=\"inlineMath\">%{MATH}</div>";
